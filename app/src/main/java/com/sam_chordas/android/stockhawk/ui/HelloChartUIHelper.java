...
public class HelloChartUIHelper {
    ...
    public static void initChart(Context context, LineChartView chartView,
                                 ArrayList<HistoricalQuoteModel>
                                         historicalData, int intervalType) {

        LineChartData chartData = generateChartLineData(historicalData);
        setUpChartData(context, chartData, chartView, intervalType);
    ...
    @DataInterval.IntervalType
    private static void setUpChartData(Context context, LineChartData chartData, LineChartView
            chartView, int intervalType) {
        ...
        axisX.setName(DataInterval.getXAxisName(context, intervalType));
        axisY.setName(context.getString(R.string.axis_title_price));
